...
#' -> See README, DFM() implements simple baseline versions of Algorithms that have been around for a while in Matlab, and in other langaues (R Python) but inside more elaborate nowcasting codes, thus not directly accessible, and less efficient.
