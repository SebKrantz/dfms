...
#' -> See README, DFM() implements simple baseline versions of algorithms that have been around for a while in Matlab, and in other langaues (R, Python, Julia) inside more elaborate nowcasting codes - thus not directly accessible, and less efficient.
...
#' -> Packages *nowcasting* and *nowcastDFM* are not on CRAN
