...
```{r news}
# Create old vintage with a new quarterly release at the ragged edge
...
# Set some observed values to zero
set.seed(1)
X_old[nrow(X_old), sample(obscurr, 10)] <- NA
# Also check series missing the previous observation and set some to zero
